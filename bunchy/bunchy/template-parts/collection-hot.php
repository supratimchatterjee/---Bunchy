...
$bunchy_limit      = bunchy_get_hot_posts_limit();
$bunchy_post_ids   = bunchy_get_hot_post_ids( $bunchy_limit );
...
$bunchy_query_args = apply_filters( 'bunchy_hot_posts_query_args', $bunchy_query_args );
...
<?php if ( $bunchy_query->have_posts() ) : ?>
	...
	<?php
	$bunchy_settings = apply_filters( 'bunchy_hot_entry_settings', array(
		'elements' => array(
			'featured_media' => true,
			'categories'     => false,
			'title'          => true,
