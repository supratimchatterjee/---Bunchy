...
<div id="buddypress">
	...
	<form action="" method="post" id="groups-directory-form" class="dir-form">
		...
		<div class="item-list-tabs" role="navigation">
			<ul>
				<li class="selected" id="groups-all"><a href="<?php bp_groups_directory_permalink(); ?>"><?php printf( esc_html__( 'All Groups %s', 'bunchy' ), '<span>' . esc_html( bp_get_total_group_count() ) . '</span>' ); ?></a></li>

				<?php if ( is_user_logged_in() && bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) : ?>
					<li id="groups-personal"><a href="<?php echo esc_url( bp_loggedin_user_domain() . bp_get_groups_slug() . '/my-groups/' ); ?>"><?php printf( esc_html__( 'My Groups %s', 'bunchy' ), '<span>' . esc_html( bp_get_total_group_count_for_user( bp_loggedin_user_id() ) ) . '</span>' ); ?></a></li>
				<?php endif; ?>
		...
		<div class="item-list-tabs" id="subnav" role="navigation">
			<ul>
				...
				<li id="groups-order-select" class="last filter">
					...
					<label for="groups-order-by"><?php esc_html_e( 'Order By:', 'bunchy' ); ?></label>

					<select id="groups-order-by">
						<option value="active"><?php esc_html_e( 'Last Active', 'bunchy' ); ?></option>
						<option value="popular"><?php esc_html_e( 'Most Members', 'bunchy' ); ?></option>
						<option value="newest"><?php esc_html_e( 'Newly Created', 'bunchy' ); ?></option>
						<option value="alphabetical"><?php esc_html_e( 'Alphabetical', 'bunchy' ); ?></option>
