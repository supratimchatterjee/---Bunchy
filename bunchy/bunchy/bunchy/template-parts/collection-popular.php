...
$bunchy_limit      = bunchy_get_popular_posts_limit();
$bunchy_post_ids   = bunchy_get_popular_post_ids( $bunchy_limit );
...
$bunchy_query_args = apply_filters( 'bunchy_popular_posts_query_args', $bunchy_query_args );
