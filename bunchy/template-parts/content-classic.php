...
<article id="post-<?php the_ID(); ?>" <?php post_class( 'entry-tpl-index entry-tpl-index-stickies' ); ?>>
	...
	<?php /*?>	<header class="entry-header">
		...
		<?php /*?><?php if ( bunchy_can_use_plugin( 'snax/snax.php' ) ) : ?>
    ...
    <?php if ( $bunchy_elements['author'] && $bunchy_elements['avatar'] ) : ?>
		...
		<?php /*?><?php if ( $bunchy_elements['author'] && $bunchy_elements['avatar'] ) : ?>
			<p class="entry-meta entry-meta-with-avatar">
		<?php else : ?>
			<p class="entry-meta">
		<?php endif; ?>
	...
	<?php /*?><div class="entry-actions snax">
