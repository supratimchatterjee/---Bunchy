...
<div class="g1-body-inner">
	...
	<div id="page">
		...
		<?php if ( bunchy_show_global_navbar() ) : ?>
			<?php /*?><div class="g1-row g1-row-layout-full g1-navbar">
			...
			<div class="g1-row g1-row-layout-full g1-header">
				<div class="g1-row-inner">
					<div class="g1-column g1-dropable">
                        ...
                        <?php wp_nav_menu( array( 'theme_location' => 'bunchy_primary_nav', 'container'  => 'nav',
		...
		<?php endif; ?>
						...
						<?php /*?><?php get_template_part( 'template-parts/nav-user' ); ?><?php */?>
