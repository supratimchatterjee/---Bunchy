	...
	<div class="acomment-wrapper">
		...
		<div class="acomment-options">
			...
			<?php if ( is_user_logged_in() && bp_activity_can_comment_reply( bp_activity_current_comment() ) ) : ?>
				...
				<a href="#acomment-<?php echo absint( bp_get_activity_comment_id() ); ?>" class="acomment-reply bp-primary-action" id="acomment-reply-<?php echo absint( bp_get_activity_id() ); ?>-from-<?php echo esc_attr( bp_get_activity_comment_id() ); ?>"><?php esc_html_e( 'Reply', 'bunchy' ); ?></a>
